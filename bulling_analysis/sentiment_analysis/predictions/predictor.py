...
from bulling_analysis.sentiment_analysis.utils.constants import PREPARED_DATASET_FILE_PATH
from bulling_analysis.sentiment_analysis.utils.preparation import TextPreparation
...
class Predictor:
    ...
    def __init__(self):
        ...
        with open(os.path.join(os.path.dirname(__file__), PREPARED_DATASET_FILE_PATH)) as file:
